...
title = The Linux Sage
# (str) Package name
package.name = linuxkb

# (str) Package domain (needed for android/ios packaging)
package.domain = io.github.alexolivet

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,png,jpg,jpeg,kv,atlas,json,mp3,ttf,otf,txt,md,db,sqlite3,sqlite
...
# NOTE: do NOT exclude generic names like "screens"/"services"/"ui" here because
# Buildozer excludes directories by name anywhere in the tree (which would also
# exclude app/screens, app/services, app/ui).
source.exclude_dirs = .buildozer,.buildozer_env,.continue,bin,build,dist,venv,.venv,__pycache__,tests,.git,.github

# (list) List of exclusions using pattern matching
# Do not prefix with './'
source.exclude_patterns = __pycache__/*,*/__pycache__/*,*.pyc,*.pyo,*.spec
...
requirements = python3==3.11.9,hostpython3==3.11.9,kivy==2.3.0,kivymd==1.2.0,requests,urllib3,certifi,packaging,flatbuffers,protobuf,mpmath,sympy,numpy1,onnxruntime_np1,tokenizers
...
presplash.filename = %(source.dir)s/assets/images/Linux_mascot_tux.png

# (str) Icon of the application
icon.filename = %(source.dir)s/assets/images/Linux_mascot_tux.png
...
android.ndk_path = /home/alexa/android-tools/android-ndk-r25c

# (str) Android SDK directory (if empty, it will be automatically downloaded.)
#android.sdk_path = /mnt/c/Users/alexa/AppData/Local/Android/Sdk/platforms/android-34
...
# Explicitly declare the python entrypoint file at the root.
entrypoint = main.py
...
# Helpful when debugging startup crashes
...
# This helps avoid stale bytecode being packaged and also makes tracebacks line up.
...
#p4a.extra_args = hostpython=/home/alexa/kivy_clean_app/venv/bin/python3
